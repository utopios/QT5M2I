...
QT_MOC_LITERAL(1, 11, 12), // "contactAdded"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "Contact&"
QT_MOC_LITERAL(4, 34, 7), // "contact"
QT_MOC_LITERAL(5, 42, 17) // "handleValidButton"

    },
    "FormWidget\0contactAdded\0\0Contact&\0"
    "contact\0handleValidButton"
};
...
void FormWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->contactAdded((*reinterpret_cast< Contact(*)>(_a[1]))); break;
        case 1: _t->handleValidButton(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FormWidget::*)(Contact & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FormWidget::contactAdded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FormWidget::contactAdded(Contact & _t1)
{
